...
2|2015/11/10|(파이션 기초)  2장 변수,표현식,문장와  3장 조건부실행(안효준), 4장 함수(이찬희 )<br/>[(Theano)  Theano 기초 - NumPy refresher과 Baby Steps - Algebra](https://github.com/biospin/DeepBio/blob/master/part01/Week1_151110/DeepBio_Theano_sejinpark.ipynb)(박세진)  |   xxx님 
